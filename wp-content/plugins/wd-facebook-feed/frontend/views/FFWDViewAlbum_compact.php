      ...
      <div id="ffwd_container2_<?php echo $ffwd; ?>">
          ...
          <div id="<?php echo $form_child_div_id; ?>" style="<?php echo $form_child_div_style; ?>">
            <?php if($ffwd_info["fb_name"]) { ?>
              ...
              if ($type == 'gallery') {
                ?>
                <a class="bwg_back_<?php echo $ffwd; ?>" onclick="ffwd_frontend_ajax('ffwd_front_form_<?php echo $ffwd; ?>', '<?php echo $ffwd; ?>', '', 'back', '', 'album')"><?php echo __('Back', 'bwg'); ?></a>                   <?php
              }
            ?>
            <div id="<?php echo $album_gallery_div_id; ?>" class="<?php echo $album_gallery_div_class; ?>" >
              ...
              if ($type != 'gallery') {
                if (isset($page_nav) && !$page_nav['total']) {
                  ?>
                  <span class="bwg_back_<?php echo $ffwd; ?>"><?php echo __('Album is empty.', 'bwg'); ?></span>
                  <?php
                }

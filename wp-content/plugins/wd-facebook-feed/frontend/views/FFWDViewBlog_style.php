...
class FFWDViewBlog_style {
  ...
  public function display($params, $from_shortcode = 0, $ffwd = 0) {
    ...
    if (!$theme_row) {
      echo WDW_FFWD_Library::message(__('There is no theme selected or the theme was deleted.', 'bwg'), 'error');
      return;
    }

    $ffwd_data = $this->model->get_ffwd_data($params['fb_id'], $ffwd_info['objects_per_page'], /*$ffwd_info['sort_by']*/'', $ffwd, /*$order_by*/ ' ASC');
    if (!$ffwd_data) {
      echo WDW_FFWD_Library::message(__('There are no objects in this facebook feed.', 'bwg'), 'error');
    }
                        ...
                        $href='#';
													...
													if ($show_shares_butt) {
														...
														<div class="ffwd_share_<?php echo $ffwd; ?>" >
															...
															if ($blog_style_facebook) {
																?>
																<a class="ffwd_facebook_<?php echo $ffwd; ?> ffwd_share_button_<?php echo $ffwd; ?>" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($share_url); ?>" target="_blank" title="<?php echo __('Share on Facebook', 'bwg'); ?>">
                                      <i title="Share on Facebook" class="ffwd_ctrl_btn ffwd_facebook fa fa-facebook"></i>
															...
															if ($blog_style_google) {
																?>
																<a class="ffwd_google_<?php echo $ffwd; ?> ffwd_share_button_<?php echo $ffwd; ?>" href="https://plus.google.com/share?url=<?php echo urlencode($share_url); ?>" target="_blank" title="<?php echo __('Share on Google+', 'bwg'); ?>">
<i title="Share on Google+" class="bwg_ctrl_btn bwg_google fa fa-google-plus"></i>
															...
															if ($blog_style_twitter) {
																?>
																<a class="ffwd_twitter_<?php echo $ffwd; ?> ffwd_share_button_<?php echo $ffwd; ?>" href="https://twitter.com/share?url=<?php echo urlencode($share_url); ?>" target="_blank" title="<?php echo __('Share on Twitter', 'bwg'); ?>" style="background-size: 22px !important;" >
<i title="Share on Twitter" class="bwg_ctrl_btn bwg_twitter fa fa-twitter"></i>
													...
													if ($view_on_fb) {
														...
														<div class="ffwd_view_on_<?php echo $ffwd; ?>" >
															...
															$link_to_facebook = ($ffwd_data_row->link != "" && $ffwd_data_row->type != "link" && $ffwd_data_row->type != "video") ? $ffwd_data_row->link : "https://www.facebook.com/".$ffwd_data_row->object_id;
															?>
															<a class="ffwd_view_on_facebook_<?php echo $ffwd; ?>" href="<?php echo $link_to_facebook; ?>" target="_blank" title="<?php echo __('View on facebook', 'bwg'); ?>"><?php echo __('View on facebook', 'bwg'); ?></a>
														</div>
														<?php
													}
													?>

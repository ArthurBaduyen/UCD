                ...
                <div class="ffwd-right">
                    <a href="https://web-dorado.com/products/wordpress-facebook-feed-plugin.html" target="_blank">
                        <div class="ffwd-table">
                            ...
                            <div class="ffwd-cell ffwd-cell-valign-middle">
                                <img src="http://devops.web-dorado.info/raffi/wp/wp-content/plugins/wd-google-maps/images/web-dorado.png">
                            </div>
                        </div>
                    </a>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <input  type="text" name="<?php echo WD_FB_PREFIX; ?>_app_secret"
                                       ...
                                       onchange="if(wd_fb_log_in) alert('Before change app id and secret please logout from curent app.'); else check_app('<?php echo WD_FB_PREFIX; ?>'); "/>

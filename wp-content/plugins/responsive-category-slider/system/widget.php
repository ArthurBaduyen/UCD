...
class Widget_res_cat_slider extends WP_Widget
{
  function Widget_res_cat_slider()
  {
  ...
  function form($instance)
  {
	...
	$cat_type = $instance['cat_type'];
    $category = $instance['category'];
	$list_tags = $instance['list_tags'];
	...
	$b_padding = $instance['b_padding'];
	$b_show_parent = $instance['b_show_parent'];
...
add_action( 'widgets_init', 'responsive_category_slider' );
function responsive_category_slider() {
	register_widget( 'Widget_res_cat_slider' );
}
...
function b_show_posts_by_style($style, $columns, $plugin_id, $image_size, $linkable, $_b_device_){
	...
	if(empty($url_thumb)){
		if($image_size == 'horizontal_rectangle' || $image_size == null){
			switch($columns){
				case 1: $image_thumnail = '<image src="http://docs.themelead.com/images/responsive-category-slider-1158x772.jpg" title="Responsive Category Slider" alt="Free Wordpress Content slider - Wordpress plugin from ThemeLead" />'; 
						$url_thumb = 'http://docs.themelead.com/images/responsive-category-slider-1158x772.jpg';
				break;
				default: $image_thumnail = '<image src="http://docs.themelead.com/images/responsive-category-slider-570x380.jpg" title="Responsive Category Slider" alt="Free Wordpress Content slider - Wordpress plugin from ThemeLead" />'; 
						$url_thumb = 'http://docs.themelead.com/images/responsive-category-slider-570x380.jpg';
			}
		}else if($image_size == 'square'){
			switch($columns){
				case 1: $image_thumnail = '<image src="http://docs.themelead.com/images/responsive-category-slider-1158x1158.jpg" title="Responsive Category Slider" alt="Free Wordpress Content slider - Wordpress plugin from ThemeLead" />'; 
						$url_thumb = 'http://docs.themelead.com/images/responsive-category-slider-1158x1158.jpg';
				break;
				default: $image_thumnail = '<image src="http://docs.themelead.com/images/responsive-category-slider-570x570.jpg" title="Responsive Category Slider" alt="Free Wordpress Content slider - Wordpress plugin from ThemeLead" />'; 
			...
			switch($columns){
				case 1: $image_thumnail = '<image src="http://docs.themelead.com/images/responsive-category-slider-1158x1737.jpg" title="Responsive Category Slider" alt="Free Wordpress Content slider - Wordpress plugin from ThemeLead" />'; 
						$url_thumb = 'http://docs.themelead.com/images/responsive-category-slider-1158x1737.jpg';
				break;
				default: $image_thumnail = '<image src="http://docs.themelead.com/images/responsive-category-slider-570x855.jpg" title="Responsive Category Slider" alt="Free Wordpress Content slider - Wordpress plugin from ThemeLead" />'; 
